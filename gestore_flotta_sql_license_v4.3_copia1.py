...
class SistemaGestionaleFlotta:
    ...
    def setup_tab_presenze(self, perm):
        ...
        ctk.CTkLabel(tb, text=f"Anno: {self.anno_corrente_str}", font=("Helvetica", 12, "bold"),
                     text_color="#aaa").pack(side="left", padx=10)
    ...
    def estrai_data_da_combo(self):
        ...
        m = f"{m_index:02d}"
        return f"{g}/{m}/{self.anno_corrente_str}"
    ...
    def crea_tree(self, parent, colonne):
        ...
        tree.tag_configure('assente_tag', background='#d35400')
